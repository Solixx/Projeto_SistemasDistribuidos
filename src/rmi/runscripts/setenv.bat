...
@Set WORKDRIVE=C
@Set JDK=C:\\Users\\Asus\\.jdks\\corretto-1.8.0_402
...
@set JAVAPROJ=C:\\Users\\Asus\\Desktop\\UFP\\GitHub\\3-ano\\SistemasDistribuidos\\SD
@Set PACKAGE=_03_pingpong
@Set PACKAGE_PREFIX=edu.ufp.inf.sd.rmi
@Set PACKAGE_PREFIX_FOLDERS=edu/ufp/inf/sd/rmi
@Set SERVICE_NAME_ON_REGISTRY=PingPongService
@Set CLIENT_CLASS_PREFIX=Pong
@Set SERVER_CLASS_PREFIX=Ping
